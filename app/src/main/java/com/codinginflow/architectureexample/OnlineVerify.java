...
public class OnlineVerify {
    ...
    // and add it here.
    private static final String API_KEY = "AIzaSyDs6zfJNwxH8OUu97aJh28fm6dZzuir3zE";

    private static final HttpTransport HTTP_TRANSPORT = new NetHttpTransport();

    private static final JsonFactory JSON_FACTORY = new JacksonFactory();
    private static final String URL =
            "https://www.googleapis.com/androidcheck/v1/attestations/verify?key=AIzaSyDs6zfJNwxH8OUu97aJh28fm6dZzuir3zE";
    ...
    private static VerificationResponse onlineVerify(VerificationRequest request) {
        ...
        try {
            ...
            httpRequest = requestFactory.buildPostRequest(url, new JsonHttpContent(JSON_FACTORY, request));
