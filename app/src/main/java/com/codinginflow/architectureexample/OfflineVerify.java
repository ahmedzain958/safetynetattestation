...
public class OfflineVerify {
    ...
    public static void process(String signedAttestationStatement) {
        ...
        if (stmt == null) {
            System.err.println("Compa --- Failure: Failed to parse and verify the attestation statement.");
            return;
        }

        System.out.println("Compa --- Successfully verified the attestation statement. The content is:");

        System.out.println("Compa --- Nonce: " + Arrays.toString(stmt.getNonce()));
        System.out.println("Compa --- Timestamp: " + stmt.getTimestampMs() + " ms");
        System.out.println("Compa --- APK package name: " + stmt.getApkPackageName());
        System.out.println("Compa --- APK digest SHA256: " + Arrays.toString(stmt.getApkDigestSha256()));
        System.out.println("Compa --- APK certificate digest SHA256: " +
                Arrays.deepToString(stmt.getApkCertificateDigestSha256()));
        System.out.println("Compa --- CTS profile match: " + stmt.isCtsProfileMatch());
        System.out.println("Compa --- Has basic integrity: " + stmt.hasBasicIntegrity());
